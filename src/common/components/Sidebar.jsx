...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-40 md:z-30 flex flex-shrink-0 transition-transform duration-300 ease-in-out ${
      ...
      style={{
        ...
        <div 
          className={`flex flex-col h-full shadow-2xl transition-all duration-300 ease-in-out w-full md:w-auto overflow-y-auto`}
          style={{ 
