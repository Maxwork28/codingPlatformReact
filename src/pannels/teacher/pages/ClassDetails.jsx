    ...
    return (
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
        ...
        <div className="space-y-4">
          ...
          {isCodingQuestionType(questionReport.question.type) ? (
            <CodingQuestionDetails question={questionReport.question} tone="report" publicTests={questionReport.question.testCases} />
