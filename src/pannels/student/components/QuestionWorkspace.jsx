    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="border-t border-gray-200 bg-gray-50 px-6 py-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={onSubmit}
            disabled={isSubmitting || !isQuestionActive || questionLocked || isQuestionSubmitted}
            className={`inline-flex items-center rounded-lg px-4 py-2 text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 ${
              isSubmitting || !isQuestionActive || questionLocked || isQuestionSubmitted
                ? 'bg-gray-400 cursor-not-allowed'
                : 'bg-green-600 hover:bg-green-700'
            }`}
          >
            {isSubmitting ? 'Submitting...' : isQuestionSubmitted ? 'Already Submitted' : questionLocked ? 'Time Expired' : 'Submit Answer'}
          </button>
